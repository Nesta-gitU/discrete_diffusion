...
class DiT(nn.Module):
    ...
    def forward_with_cfg(self, x, t, y, cfg_scale):
        ...
        """
        raise Exception("classifier free guidance isnt correctly implemented!")
...
def DiT_XL_2(**kwargs):
    return DiT(depth=28, hidden_size=1152, output_size=1152, num_heads=16, **kwargs)
...
def DiT_L_2(**kwargs):
    return DiT(depth=24, hidden_size=1024, output_size=1024, num_heads=16, **kwargs)
...
def DiT_B_2(**kwargs):
    return DiT(depth=12, hidden_size=768, output_size=768, num_heads=12, **kwargs)
...
def DiT_S_2(**kwargs):
    return DiT(depth=12, hidden_size=384, output_size=384, num_heads=6, **kwargs)
